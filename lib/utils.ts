...
/**
 * Canonical Levenshtein edit-distance implementation.
 * Used by match-detection, claim scoring, and invite dedup — single source of
 * truth so all callers use the same algorithm and threshold semantics.
 */
